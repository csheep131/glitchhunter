...
4. Human-in-the-Loop: Generate detailed report + Draft-PR
...
Exports:
    ...
    - GitHubPRCreator: GitHub Draft-PR Erstellung
    - GitLabMRCreator: GitLab Draft-MR Erstellung
    - PRCreatorFactory: Factory für PR-Creator
"""
